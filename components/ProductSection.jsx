    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          <div>
             <h2 className="text-2xl md:text-3xl font-bold uppercase text-gray-900 tracking-wide mb-2">Our Bestselling Coffee Products</h2>
             <p className="text-gray-900">Curated selection of premium coffee machines</p>
          </div>
            ...
            <div key={product.id} className="group relative">
                ...
                <div className="bg-white rounded-xl overflow-hidden transition-all duration-300 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] border border-transparent hover:border-gray-100">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      <span className="text-xs text-gray-700 font-medium">({product.reviews} Reviews)</span>
                    </div>
              ...
              <div className="absolute bottom-6 right-6 z-10">
                <button 
                    ...
                    className="bg-black text-white text-xs font-bold px-4 py-2 rounded hover:bg-[#d97706] transition-colors uppercase tracking-wide"
                >
                    Add to Cart
                </button>
              </div>
