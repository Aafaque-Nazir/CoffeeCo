                ...
                <div className="lg:col-span-3">
                    <div className="bg-white border border-gray-100 rounded-2xl p-8 mb-8">
                        ...
                        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                <button className="bg-black text-white px-8 py-3 rounded-full font-bold hover:bg-[#d97706] transition-colors uppercase tracking-wider">
                                    Save Changes
                                </button>
                            </div>
                        </form>
                    ...
                    <div className="bg-white border border-gray-100 rounded-2xl p-8">
                        <h2 className="text-2xl font-bold mb-8 uppercase">Recent Orders</h2>
                        <div className="space-y-6">
                            {[1, 2].map((order) => (
                                <div key={order} className="flex flex-col md:flex-row justify-between items-center p-6 bg-gray-50 rounded-xl border border-gray-100">
                                    <div className="flex items-center space-x-6 mb-4 md:mb-0">
                                        <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center text-gray-300">
                                            <Package className="w-8 h-8" />
                                        </div>
                                        <div>
                                            <p className="font-bold">Order #2458{order}</p>
                                            <p className="text-xs text-gray-500">Placed on March {10 + order}, 2024</p>
                                    ...
                                    <div className="text-right">
                                        <p className="font-bold text-lg">₹{(12000 * order).toLocaleString()}</p>
                                        <button className="text-[#d97706] text-sm font-bold hover:underline mt-1">
                                            View Details
                                        </button>
                                    </div>
                                </div>
